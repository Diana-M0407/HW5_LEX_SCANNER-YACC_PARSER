...
{
  "\"end of file\"", "error", "\"invalid token\"", "INTEGER", "INVALID",
  "'+'", "'-'", "'*'", "'/'", "UMINUS", "'\\n'", "'('", "')'", "$accept",
  "INPUT", "LINE", "E", "T", "F", YY_NULLPTR
};
...
{
      -9,     0,    -9,    -8,    -9,     1,    -9,     1,    -9,    11,
      15,    -9,    -9,    -9,     3,     2,     2,    -9,     2,     2,
      -9,    15,    15,    -9,    -9
};
...
{
       2,     0,     1,     0,    14,     0,     5,     0,     3,     0,
      10,    13,     6,     9,     0,     0,     0,     4,     0,     0,
      15,     7,     8,    11,    12
};
...
{
       2,     3,    12,     4,     4,     4,     5,     5,    15,    16,
       6,     7,     7,     7,     0,    20,    15,    16,    13,     0,
      14,    17,    18,    19,    21,    22,    23,    24
};

static const yytype_int8 yycheck[] =
{
       0,     1,    10,     3,     3,     3,     6,     6,     5,     6,
      10,    11,    11,    11,    -1,    12,     5,     6,     5,    -1,
       7,    10,     7,     8,    15,    16,    18,    19
};
...
{
       0,    14,     0,     1,     3,     6,    10,    11,    15,    16,
      17,    18,    10,    16,    16,     5,     6,    10,     7,     8,
      12,    17,    17,    18,    18
};
